...
// The component no longer needs to receive transactions as a prop
export function SpendingChart() {
  // Access state directly from the context
  const { currency, categories, transactions } = useAuth();
  ...
  // Correctly generate chartData using the category name directly
